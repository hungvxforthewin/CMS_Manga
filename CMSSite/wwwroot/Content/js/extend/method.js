...
function _AjaxPostFalse(url, data, funcSuccess) {
    $.ajax({
        url: url,
        type: "POST",
        data: JSON.stringify(data),
...
function GetValueDateVal(value) {
    return moment(value, 'DD/MM/YYYY').format("YYYY-MM-DD");
}
var cusmodal = {
    html: '<div class=\"modal fade\" id=\"mdlCustom\" role=\"dialog\" data-keyboard=\"false\" data-backdrop=\"static\">\
            <div class=\"modal-dialog\">\
              <div class=\"modal-content\">\
              </div>\
            </div>\

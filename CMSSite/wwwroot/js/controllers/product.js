var product = {
    ...
    load: function () {
        ...
        $("body").on('change', '#drdView', function () {
            if ($(this).val() == '1') {
                ...
                if (id == undefined) {
                    ...
                    cusmodal.ShowView("/Products/Detail/" + id, function () {
                ...
                if (id == undefined) {
                    ...
                    app.component.Loading.Show();
                    cusmodal.ShowView("/Products/Edit/" + id, function () {
                        app.component.Loading.Hide();
                        app.component.Select2();
                        app.component.ValidateInputPhone();
                        $("#frmAdd").on("submit", function (event) {
                            ...
                            _AjaxPostForm("/Products/Insert_Update", { data }, function (rs) {
                                if (rs.success) {
                                    $("#tblCustomer").bootstrapTable("refresh");
                ...
                if (id == undefined) {
                    ...
                    modal.DeleteComfirm({
                        ...
                        callback: function () {
                            _AjaxPostForm('/Products/Delete/', { id: id }, function (rs) {
                                if (rs.success) {
                                    notifySuccess(rs.message);
                                    $("#tblCustomer").bootstrapTable("refresh");
                                }
        ...
        $("#btnDoneExportExcel").on("click", function () {
            _AjaxPostForm("/Products/WriteDataToExcel", {
        ...
        $("#btnAdd").click(function () {
            app.component.Loading.Show();
            cusmodal.ShowView("/Products/Create", function () {
                app.component.Loading.Hide();

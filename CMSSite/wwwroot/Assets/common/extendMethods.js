...
var ArrayIndexExtend = function (_this, elm, isEqual, isIgnorecase) {
...
var multiselect = {
    optionsDefault: {
        ...
        selectAllText: 'Chọn tất',
        buttonText: function (options, select) {
            if (options.length === 0) {
                return 'Chưa chọn';
            }
            else if (options.length > 4) {
                return 'Đã chọn hơn 4 lựa chọn';
            }
            else {
                var labels = [];
    ...
    getSelected: function (element, getData) {
        if (element.constructor == String) {
            element = $(element);
        }
        element = element.find("option:selected");
        var temp = element.map(function (a, item) {
            if (getData == null) {
                return item.value;
            }
            else {
...
var modal = {
                ...
                <div class=\"modal-dialog\">\
                    <div class=\"modal-content\">\
                        ...
                        <div class=\"modal-footer\">\
                            <button type=\"button\" class=\"btn btn-danger\" data-dismiss1=\"modal\" id=\"Close\">Close</button>\
    ...
    DeleteComfirm: function (options) {
        ...
        options = {
            ...
            tilte: options.title == null ? "Thông báo" : options.title ,
            message: options.message || "Bạn có chắc chắn muốn xóa?",

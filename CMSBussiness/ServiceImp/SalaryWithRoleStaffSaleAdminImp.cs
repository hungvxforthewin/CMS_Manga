...
{
    public class SalaryWithRoleStaffSaleAdminImp : BaseService<SalaryWithRoleStaff, long>, ISalaryWithRoleStaffSaleAdmin
    {
        public SalaryWithRoleStaff GetByRole(byte roleAccount)
        {
            try
            {
